...
public class Methods {
    ...
    public static void main(String[] args) {
        ...
        int lenghtR = str.length();

        boolean palin = false;

        for (int x = 0; x < lenghtR/2;x++){
            char chars = str.charAt(x);
            char chars1 = str.charAt(lenghtR - 1 - x);
            if (chars == chars1){
                palin = true;
            }
            else {
        ...
        if (palin) System.out.println("Palin");
        else System.out.println("No Palin");
